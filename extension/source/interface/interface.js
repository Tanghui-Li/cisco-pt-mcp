...
(function () {
  ...
  var TOOL_ARGS = {
    ...
    removeLink:           ["links"],
    configureEndDeviceIp: ["deviceName", "dhcpEnabled", "ipaddress",
                           "subnetMask", "defaultGateway", "dnsServer", "interfaceName"],
    configureWireless:    ["deviceName", "ssid", "authType", "encryption",
                           "password", "wepKey", "ssidBroadcastEnabled",
                           "standardChannel", "wideChannel", "networkType",
                           "wirelessPort", "macFilterEnabled", "allowAccess",
                           "macFilterEntries", "clearMacFilter", "resetAssociations",
                           "dhcpEnabled", "ipaddress", "subnetMask",
                           "defaultGateway", "dnsServer"],
    configureDhcpServer:  ["deviceName", "portName", "enabled", "poolName",
                           "removePool", "networkAddress", "subnetMask",
                           "defaultGateway", "dnsServer", "startIp", "endIp",
                           "maxUsers", "clearExcludedRanges", "excludedRanges"],
    configureHomeRouter:  ["deviceName", "internetConnectionType", "defaultGateway",
                           "remoteManagementEnabled", "clearNatEntries",
                           "natEntries", "dmzEnabled", "dmzIpAddress"],
    controlIotDevice:     ["deviceName", "digitalOutputs", "analogOutputs",
                           "opcEnabled", "cipEnabled", "profinetPorts",
                           "goosePublisherPorts", "gooseSubscriberPorts",
                           "svPublisherPorts", "svSubscriberPorts",
                           "thingRotation", "customTexts", "subComponents",
                           "serialOutput", "clearSerialOutputs", "moveTo",
                           "customVars"],
    inspectIotDevice:     ["deviceName", "attributeNames", "subComponentNames",
                           "includeSerialization", "serializationMaxChars"],
    runIotAutomation:     ["ruleName", "condition", "actions", "dryRun"],
    startIotAutomation:   ["ruleName", "condition", "actions", "intervalMs",
                           "triggerMode", "runImmediately"],
    stopIotAutomation:    ["ruleName"],
    getIotAutomationStatus: ["ruleName"],
    inspectEnvironment:   ["environmentKeys"],
    configureEnvironment: ["environmentKey", "value", "manualAdjustment", "active"],
    configureIosDevice:   ["deviceName", "commands"],
    getNetwork:           [],
    auditNetwork:         ["expectedDeviceNames", "allowedDisconnectedDeviceNames",
                           "wirelessClientDeviceNames", "requireConnectedDevices",
                           "requireGreenLinks"],
